...
<x-panel class="flex flex-row gap-x-4 relative p-4">
    ...
    <div class="flex flex-col md:flex-row md:justify-between flex-1">
        ...
        <div class="flex flex-col mt-4 md:mt-0 md:ml-4 items-end">
            ...
            <div class="flex space-x-2 items-center mt-4 md:mt-auto">
                <a wire:navigate href="{{ route('employer.jobsEdit', ['job' => $job->id]) }}">
                    <svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g id="SVGRepo_iconCarrier">
                            <path
                                ...
                                stroke="#1891c8" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                            </path>
                            <path
                    ...
                    <svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g id="SVGRepo_iconCarrier">
                            ...
                            <path d="M6 7H12H18V18C18 19.6569 16.6569 21 15 21H9C7.34315 21 6 19.6569 6 18V7Z"
                                stroke="#db1f1f" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            </path>
