...
<x-panel class="flex-col gap-y-4">
    ...
    <div class="mt-8 w-full border-t-2 py-2 items-center">
        <div class="mt-2 flex justify-between">
            ...
            <span
                class="text-sm py-2 px-2 bg-black/10 rounded-xl font-semibold hover:bg-black/30 transition-colors-duration-300 relative">{{($job->created_at)->diffForHumans()}}</span>
        </div>
    </div>
