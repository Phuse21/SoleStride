    ...
    <form wire:submit.prevent="apply" class="max-w-2xl mx-auto space-y-6">
        ...
        <x-button type="submit" wire:loading.attr="disabled" wire:target="cv">Submit
            <div wire:loading wire:target="apply">
                <div class="inline-block h-5 w-5 animate-spin rounded-full border-4 border-solid border-current border-e-transparent align-[-0.125em] text-primary motion-reduce:animate-[spin_1.5s_linear_infinite]"
                    role="status">
                    <span
