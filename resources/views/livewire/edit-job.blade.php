                ...
                <div class="max-w-2xl mx-auto space-y-6">
                    <div class="flex space-x-4">
                        <div class="w-1/2">
                            ...
                            <x-form.input type="text" name="title" id="title" wire:model.defer="title" />
                            <x-form.error name="title" />
                        </div>

                        <div class="w-1/2">
                            <x-form.label name="salary" label="Salary" />
                            <x-form.input type="text" name="salary" id="salary" wire:model.defer="salary" />
                ...
                <div class="max-w-2xl mx-auto space-y-6">
                    <div class="flex space-x-2">
                        <div class="w-2/5">
                            ...
                            <x-form.select name="minimum_qualifications" id="minimum_qualifications"
                                wire:model.defer="minimum_qualifications">
                                <option value="">--Please Select--</option>
                        ...
                        <div class="w-2/5">
                            ...
                            <x-form.select name="experience_level" id="experience_level"
                                wire:model.defer="experience_level">
                                <option value="">--Please Select--</option>
                    ...
                    <div class="flex space-x-4">
                        <div class="w-1/2">
                            ...
                            <textarea name="responsibilities" id="responsibilities" wire:model.defer="responsibilities"
                        ...
                        <div class="w-1/2">
                            ...
                            <textarea name="skills" id="skills" wire:model.defer="skills"
                    ...
                    <div class="flex space-x-4">
                        <div class="w-full">
                            ...
                            <textarea name="summary" id="summary" wire:model.defer="summary"
