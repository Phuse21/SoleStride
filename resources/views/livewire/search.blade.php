<div class="relative w-full">
    ...
    <div
        class="absolute left-1/2 transform -translate-x-1/2 mt-2 md:w-[50%] w-[70%] max-h-60 overflow-y-auto bg-white border border-gray-300 rounded-xl shadow-lg z-10">
        <ul>
