            ...
            <form wire:submit="register" class="max-w-2xl mx-auto space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:w-full w-[85%] mx-auto">
                        ...
                        <div wire:loading wire:target="logo" class="text-blue-500">
                            Uploading...
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row md:gap-4 gap-6">
                    ...
                    <div class="w-full md:w-1/2">
                        ...
                        <div wire:loading wire:target="profile_photo" class="text-blue-500">
                            Uploading...
                        </div>
                    </div>
                </div>
                ...
                <x-button type="submit" wire:loading.attr="disabled" wire:target="logo,profile_photo,register,role">
                    Create Account
