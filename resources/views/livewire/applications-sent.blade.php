<div>
    ...
    <div class="pt-6">
        <div class="items-center inline-flex gap-2">
            <span class="w-2 h-2 bg-yellow-500 inline-block"></span>
    ...
    <div class="pt-6">
        <div class="items-center inline-flex gap-2">
            ...
            <h3 class="text-lg font-bold">Accepted Applications</h3>
        </div>
        <div class="grid lg:grid-cols-3 gap-8 mt-4 mb-20">
            @forelse($applications->where('status', 'accepted') ?? [] as $job)
                <x-job-card :job="$job->job" />
            @empty
    ...
    <div class="pt-6">
        <div class="items-center inline-flex gap-2">
            ...
            <h3 class="text-lg font-bold">Declined Applications</h3>
        </div>
        <div class="grid lg:grid-cols-3 gap-8 mt-4 mb-20">
            @forelse($applications->where('status', 'declined') ?? [] as $job)
                <x-job-card :job="$job->job" />
            @empty
