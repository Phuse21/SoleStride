        ...
        <div class="w-full mx-auto border-b overflow-y-auto h-full">
            <div class="h-fit w-full flex flex-col items-center gap-5">
                ...
                <div
                    ...
                    <div class="flex flex-col items-start justify-start border-t border-light_blue w-full p-2">
                        <p class="text-zinc-400 text-sm font-content w-full capitalize">Accepted Applications</p>
                        <p class="text-base font-medium text-black font-content capitalize">
                            {{ $applications?->where('status', 'accepted')->count() ?? 'N/A' }}
                        </p>
                    </div>
                    <div class="flex flex-col items-start justify-start border-t border-light_blue w-full p-2">
                        <p class="text-zinc-400 text-sm font-content w-full capitalize">Declined Applications</p>
                        <p class="text-base font-medium text-black font-content capitalize">
                            {{ $applications?->where('status', 'declined')->count() ?? 'N/A' }}
                        </p>
                    </div>
                    <div class="flex flex-col items-start justify-start border-t border-light_blue w-full p-2">
